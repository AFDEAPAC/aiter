...
#define MLA_DECODE_OPUS_PYBIND                  \
    m.def("mla_decode_opus_fwd",                 \
          &mla_decode_opus_fwd,                 \
          py::arg("q"),                         \
          py::arg("unified_kv"),                \
          py::arg("kv_indices"),               \
          ...
          py::arg("softmax_scale"),            \
          py::arg("qlen"));                    \
    m.def("mla_decode_opus_splitkv_fwd",         \
          ...
          py::arg("qlen"),                     \
          py::arg("num_splits"));               \
    m.def("mla_decode_opus_qpack_fwd",           \
          ...
          py::arg("softmax_scale"),            \
          py::arg("qlen"));                     \
    m.def("mla_decode_opus_qpack_h8_fwd",        \
          ...
          py::arg("softmax_scale"),            \
          py::arg("qlen"));                     \
    m.def("mla_decode_opus_qpack_splitkv_fwd",   \
          ...
          py::arg("qlen"),                     \
          py::arg("num_splits"));               \
    m.def("mla_decode_opus_rope_fwd",            \
          ...
          py::arg("softmax_scale"),            \
          py::arg("qlen"));                     \
    m.def("mla_decode_opus_rope_splitkv_fwd",    \
          ...
          py::arg("qlen"),                     \
          py::arg("num_splits"));               \
    m.def("mla_decode_opus_rope_qpack_fwd",      \
          ...
          py::arg("softmax_scale"),            \
          py::arg("qlen"));                     \
    m.def("mla_decode_opus_rope_qpack_splitkv_fwd", \
